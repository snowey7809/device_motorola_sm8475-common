...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/media/media_codecs_cape_custom.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_cape_custom.xml \
    ...
    $(LOCAL_PATH)/media/media_codecs_performance_cape_custom.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_performance_cape_custom.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/moto-telephony.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/moto-telephony.xml
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/aac_richtap.config:$(TARGET_COPY_OUT_ODM)/etc/aac_richtap.config
